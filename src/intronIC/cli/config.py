...
class TrainingConfig:
    ...
    scoring_mode: str = "pmotif_adjudicated"   # pmotif_adjudicated | raw_gated | zscore (legacy; not scoreable post-z-stack-removal)
    n_cv_folds: int = 7
...
class IntronICConfig:
    ...
    def from_args(
        ...
        training_config = TrainingConfig(
            ...
            scoring_mode=getattr(args, "scoring_mode", "pmotif_adjudicated"),
